...
To understand the behavior of the system, we also include a few distorted samples to the test set: for each digit we select one sample and include its distortions as described in the methodology.

...
\begin{figure*}[h]
    ...
    \end{subfigure}
    \caption{2D Plot of our model embedding on the NORB 1-plane train+test after $100'000$ iterations. A few random samples were shown to represent the local trend.}
...
However there is still room for improvements, especially for the quantitative measures which doesn't always reflect the structure quality quantified by a visual inspection.

...
We think that by lacking any form of measures, DrLIM paper doesn't promote the continuation of its work because there is no common way to measure ``better''.
...
However, DrLIM paper doesn't provide the margin which is problematic to reproduce their work.
...
Once again we train our network following our conventions on a subset of the NORB dataset.
As we previously described, this subset is composed of all viewpoint of a single plane which was used in the DrLIM paper.
...
We had great difficulties to reproduce DrLIM on NORB due to the lack of directives for parameters and due to the initial randomness of model initialization.

...
They use the Siamese training architecture to present image pairs which are optimized to be close if similar or far otherwise.
...
In this chapter, we will describe the general environment we used to produce our experiments and the settings to reproduce them.
...
We quickly discuss how our datasets based on MNIST and NORB are generated and how they relate to the prior works.
Finally, we discuss what quantitative measures we used for comparisons.

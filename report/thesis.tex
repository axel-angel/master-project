...
wanted to create invariant-model for classification and decode the fingerprint with t-sne to create a simple coherent plot where class and distortion would be cleanly separated into different axes.
